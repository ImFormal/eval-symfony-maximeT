 ...
 */
final class Version20250328150533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE task CHANGE created_at created_at DATETIME NOT NULL, CHANGE expired_at expired_at DATETIME NOT NULL, CHANGE status status TINYINT(1) DEFAULT NULL
        SQL);
    }
